...
@Component
public class CircleListByBlock123 implements CommandLineRunner {

    @Value("${CircleListByBlock123.url:http://reitaisai.com/circlelist/block123/}")
    private String url;

    @Value("${CircleListByBlock123.html:true}")
    private boolean html;

    @Value("${CircleListByBlock123.htmlfile:block123.html}")
    private String htmlfile;

    @Value("${CircleListByBlock123.csv:true}")
    private boolean csv;

    @Value("${CircleListByBlock123.csvfile:block123.csv}")
    private String csvfile;

    @Value("${CircleListByBlock123.jsonfile:block123.json}")
